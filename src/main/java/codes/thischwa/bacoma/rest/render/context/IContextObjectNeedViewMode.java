...
/**
 * IInteface for velocity context objects, managed by spring. Have to be
 * implemented by all beans needed in every template, which requires the
 * {@link ViewMode} object.
 */
